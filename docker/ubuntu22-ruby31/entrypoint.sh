...
for source in docker/phase4/config/*.yml; do
...
if [[ -f "docker/phase4/Gemfile.lock" && ! -f "Gemfile.lock" ]]; then
  cp "docker/phase4/Gemfile.lock" "Gemfile.lock"
fi
...
bundle_version="${BUNDLER_VERSION:-2.2.3}"
