class Gwbbs::Theme < Gw::Database
  ...
  belongs_to :board, optional: true, :foreign_key => :board_id, :class_name => 'Gwbbs::Control'
  belongs_to :theme, optional: true, :foreign_key => :theme_id, :class_name => 'Gwboard::Theme'
